							...
							<div class="profile-left" style="margin-left: 492px ;margin-right:492px;margin-top: 20px;">
								...
								<div class="profile-header">
									...
									<div class="profile-main">
										...
										<h3 class="name">${companyWantedOne.c_name}</h3>
								...
								<div class="profile-detail">
									<div class="profile-info">
										...
										<form action="/wanted2/company/companyUpDWanted.do?w_id=${companyWantedOne.w_id }" method="post">
										<ul class="list-unstyled list-justify">
										
											<li>工作地点<td><input type="text" name="w_addr" value="${companyWantedOne.w_addr}">
					></li>
											<li>月薪<input type="text" name="w_salary" value="${companyWantedOne.w_salary}">
					></li>
											<li>人数<input type="text" name="w_num" value="${companyWantedOne.w_num}">
					></li>
											<li>岗位<input type="text" name="w_job" value="${companyWantedOne.w_job}">
					></li>
											<li>要求<input type="text" name="w_require" value="${companyWantedOne.w_require}">
					></li>
				
										</ul>
											<div class="text-center"><input type="submit"  class="btn btn-primary" value="保持"></div>
